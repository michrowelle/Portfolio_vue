...
const projects = [
    {
        ...
        category: 'motion',
        image: 'img/CIBTM3_2480.jpg',
        year: '2023',
        team: 'Lena Lazaridis<br>Michelle Raschke<br>Yasmin Rademann',
        displayed: 'Trial&Error - DIY Music Conference 2023<br>Berlin Music Video Awards 2024 - Silver Screening',
        video: 'img/230924_Final_Cut_1920x1080.mp4',
        visuals: 'img/CIBTM_projectpage.png',
    ...
    },
    {
        ...
        category: 'graphic',
        image: 'img/P9180514.jpg',
        year: '2023',
        visuals: 'img/AMORE_projectpage.png',
    ...
    },
    {
        ...
        category: 'motion',
        image: 'img/product videos.png',
        year: '2022-2024',
        team: 'Lucas König<br>Michelle Raschke',
        video: 'img/20231219_Partyspeaker_v5.mp4'+'img/20231030_Teaser_Bootcamp_quer_v2.mp4'+'img/20231201_Saugroboter_X20_V2.mp4',
        visuals: 'img/productvideos.png',
    ...
    },
    {
        ...
        category: 'motion',
        image: 'img/02_1.1.3.png',
        year: '2022',
        team: 'Lucas König<br>Michelle Raschke',
        video: 'img/unPerfekt_Ein Medion Weihnachtsfilm_V2.mp4',
        visuals: 'img/unPERFEKT_projectpage.png',
    ...
    },
    {
        ...
        image: 'img/94C4DC14-1490-4C33-ABC8-0A4381FC8C28_1_105_c.jpeg',
        year: '2022',
        visuals: 'img/NewWays_projectpage.png',
    ...
    },
    {
        ...
        category: 'graphic',
        image: 'img/iPhone B06.png',
        year: '2023',
        team: 'Lena Lazaridis<br>Michelle Raschke<br>Lukas Rudolph',
        video: 'img/P3_Lazaridis_Raschke_Rudolph_MD21B_Hassenstein_Walkthrough_App.mp4',
        visuals: 'img/Intentio_projectpage.png',
...
const createCard = (project) => {
    ...
    <div class="card ${cardId}">
        <h2>${project.title}</h2>
        <p>${project.shortdescription}<p>${project.year}</p>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    projects.forEach(project => {
        productContainer.innerHTML += createCard(project);
    });
});
